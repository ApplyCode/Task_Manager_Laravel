...
class AppointmentController extends Controller
{
    ...
    {
        // get all appointments for the current user and eager load the tasks and user
        $myAppointments = Appointment::forUser('and')->withTasks()->withUser()->get();
        // get all appointments and eager load the tasks and user
        $appointments = Appointment::withTasks()->withUser()->get();
        // return the appointments view with the appointments
