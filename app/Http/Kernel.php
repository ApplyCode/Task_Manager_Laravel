...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'get-top-patients-users' => \App\Http\Middleware\GetTopPatientsUsers::class,
        'get-all-patients-users-categories-labels' => \App\Http\Middleware\GetAllPatientsUsersCategoriesLabels::class,
