...
use App\Services\Params\Appointments\StoreServiceParams;
...
class AppointmentService
{
    ...
    public function getEndedAppointments( $userId = null, ?int $limit = null, bool $isCount = false)
    {
    ...
    public function getConfirmedAppointments( $userId = null, bool $isCount = false)
    {
        $query = $this->appointmentModel
            ->where('status', 'confirmed');
